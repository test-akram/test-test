---
name: IoT Clusters MQTT
description: A high-performance broker built with Go and Redis, designed for IoT applications.
github: https://github.com/BarriBarri20/comqtt
icon: CloudComputing
image: /static/images/projects/iot-cluster.png
repo: iot-clusters-mqtt
techstack:
  - label: Go
  - label: MQTT
  - label: Redis
