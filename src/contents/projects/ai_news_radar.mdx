---
name: AI News Radar
description: A platform built during a competition to aggregate and categorize the latest AI news using Django, Scrapy, asyncio, and Selenium
github: https://github.com/your-username/your-repo
icon: Pencil
image: /static/images/projects/ai-news-aggregator/cover.png
repo: your-repo-name
techstack:
  - label: Python
  - label: Django
