...
homepage: https://yourprojectwebsite.com
github: https://github.com/yourusername/yourproject
icon: Gear
image: /static/images/projects/mechanical-simulation/cover.png
repo: yourproject
techstack:
  - label: Python
  - label: NumPy
...
For more information and to access the project, please visit the [project homepage](https://yourprojectwebsite.com) or [GitHub repository](https://github.com/yourusername/yourproject).
