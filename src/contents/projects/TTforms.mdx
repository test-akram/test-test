---
name: TTForm
description: A web application built with Bootstrap, Django, and Django Rest Framework that offers an enhanced alternative to Google Forms, providing administrators with more control and improved data collection and statistics for Tunisie Telecom.
homepage: https://ttform.example.com
github: https://github.com/your-username/ttform
icon: Globe
image: /static/images/projects/ttform/cover.png
repo: ttform
techstack:
  - label: Python
  - label: Django
...
Experience the power of TTForm by visiting the [homepage](https://ttform.example.com). The project is open-source and available on [GitHub](https://github.com/your-username/ttform), where you can explore the code, contribute to its development, or deploy it for your own data collection needs. Simplify data collection and enhance statistical analysis with TTForm, the ultimate solution for Tunisie Telecom.